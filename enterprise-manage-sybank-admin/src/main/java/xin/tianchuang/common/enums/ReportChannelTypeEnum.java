 ...
 *
 */
public enum ReportChannelTypeEnum implements IntEnum {
	...
	HOLDER(8, "股东变更"), //
	STAFF(9, "主要人员变更"), //
	LAW_SUIT_PLAINTIFFS(10, "法律诉讼原告"), //
	
	LAW_SUIT_DEFENDANTS(11, "法律诉讼被告"), //
	COURT_ANNOUNCE_PLAINTIFFS(12, "法院公告原告"), //
	...
	ReportChannelTypeEnum(int key, String desc) {
		this.key = key;
		this.desc = desc;
	}
