...
import xin.tianchuang.modules.sys.dao.SysRoleDao;
import xin.tianchuang.modules.sys.entity.SysRoleEntity;
import xin.tianchuang.modules.sys.service.SysRoleMenuService;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleDao, SysRoleEntity> implements SysRoleService {
	...
	private void checkPrems(SysRoleEntity role){
		...
		if(!menuIdList.containsAll(role.getMenuIdList())){
			throw new SpiderException("新增角色的权限，已超出你的权限范围");
		}
	}
}
