...
import xin.tianchuang.modules.sys.dao.SysUserDao;
import xin.tianchuang.modules.sys.entity.SysUserEntity;
import xin.tianchuang.modules.sys.service.SysRoleService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	private void checkRole(SysUserEntity user){
		...
		if(!roleIdList.containsAll(user.getRoleIdList())){
			throw new SpiderException("新增用户所选角色，不是本人创建");
		}
	}

	@Override
	public Page<SysUserEntity> queryByRoleId(Page<SysUserEntity> page, Long roleId, String username) {
		page.setRecords(this.baseMapper.queryByRoleId(page,roleId,username));
		return page;
	}
}
