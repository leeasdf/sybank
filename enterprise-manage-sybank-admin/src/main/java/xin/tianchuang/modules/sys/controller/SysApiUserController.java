...
//	 */
//	@GetMapping("/list")
//	@RequiresPermissions("sys:api:user:list")
...
//	@RequiresPermissions("sys:api:user:info")
...
//	@SysLog("保存用户")
//	@PostMapping("/save")
//	@RequiresPermissions("sys:api:user:save")
...
//	@SysLog("修改用户")
//	@PostMapping("/update")
//	@RequiresPermissions("sys:api:user:update")
...
//	@SysLog("删除用户")
//	@PostMapping("/delete")
//	@RequiresPermissions("sys:api:user:delete")
