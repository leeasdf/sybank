$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/rpttncourtnotice/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.rptTnCourtNotice.id == null ? "sys/rpttncourtnotice/save" : "sys/rpttncourtnotice/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "sys/rpttncourtnotice/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "sys/rpttncourtnotice/info/"+id, function(r){
